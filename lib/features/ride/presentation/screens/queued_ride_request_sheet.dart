...
class QueuedRideRequestSheet extends ConsumerWidget {
  const QueuedRideRequestSheet({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final ride = ref.watch(queuedRideProvider);
            ...
            children: [
              ...
              Expanded(
                child: GestureDetector(
                  onTap: () =>
                      ref.read(rideSessionProvider.notifier).declineQueuedRide(),
                  child: Container(
                    height: 44,
                    decoration: BoxDecoration(
              ...
              Expanded(
                ...
                child: GestureDetector(
                  onTap: () async {
                    final accepted = await ref.read(rideSessionProvider.notifier).acceptQueuedRide();
