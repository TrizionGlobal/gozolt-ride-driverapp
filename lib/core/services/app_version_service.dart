...
import 'package:gozolt_driver/core/providers/dio_provider.dart';
import 'package:gozolt_driver/core/constants/api_constants.dart';
...
class AppVersionService {
  ...
  Future<AppVersionConfig?> fetchAppVersionConfig() async {
    try {
      ...
      if (response.data != null && response.data['driverApp'] != null) {
        return AppVersionConfig.fromJson(response.data['driverApp']);
      }
      return null;
    } catch (e) {
